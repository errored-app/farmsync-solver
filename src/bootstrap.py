...
from . import console, paths, settings, update
...
def launch(argv) -> None:
    ...
    config on disk.
    """
    # Before anything prints. A click into a QuickEdit console blocks every
    # write until a key is pressed, and the menu below is the first screen an
    # operator is invited to click on.
